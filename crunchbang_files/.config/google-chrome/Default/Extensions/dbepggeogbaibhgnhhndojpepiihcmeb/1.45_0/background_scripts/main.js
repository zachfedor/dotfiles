  ...
  BackgroundCommands = {
    ...
    restoreTab: function(callback) {
      if (chrome.sessionRestore) {
        return chrome.sessionRestore.getRecentlyClosed(function(closed) {
          return chrome.sessionRestore.restore(closed[0]);
        });
      } else {
